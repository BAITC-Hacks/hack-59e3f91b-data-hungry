...
- Гибридный поиск требует доступности сервиса эмбеддингов NITEC для каждого нового запроса и реранкера для финальной сортировки; без эмбеддингов используется локальный поиск FTS5, без реранкера — гибридный порядок. Потоковая выдача ответа и сохранение истории авторизованного пользователя пока не реализованы. Публичной deployed-ссылки пока нет.
