...
- Гибридный поиск товаров по эмбеддингам NITEC и локальному индексу SQLite FTS5 с одним реранком общей выдачи через Qwen3 Reranker 8B; точный артикул имеет приоритет.
