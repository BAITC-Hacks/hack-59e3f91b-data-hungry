...
**Статус:** прототип, 23.09.2026. Развёрнут на VM Brev: демо-страница с виджетом — https://ekt-assistant.orau.kz/widget/demo/index.html, health — https://ekt-assistant.orau.kz/api/health (LLM: OpenAI gpt-4.1 через OpenAI-совместимый провайдер). Домен orau.kz с HTTPS — по готовности DNS (`deploy/vm_caddy.sh`).
