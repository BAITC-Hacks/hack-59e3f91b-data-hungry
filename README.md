...
**Статус:** прототип, 23.09.2026. Развёрнут на VM Brev (публичный URL будет добавлен), планируется домен orau.kz.
...
предложения — в памяти процесса (24 ч, теряются при рестарте); ключ LLM для публичного стенда ещё не выдан (без него — режим
