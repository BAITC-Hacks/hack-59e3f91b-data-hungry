...
**Проект доступен: [https://ekt-assistant.orau.kz](https://ekt-assistant.orau.kz).**

**Основное демо временно работает на [NVIDIA Brev](https://web-uct8xo9mo.gobrev.dev/widget/demo/index.html)**: эмбеддер и реранкер запущены локально на H200, SGR-агент, OCR и распознавание речи используют OpenAI. На новой ВМ выше доступ к NITEC пока не работает; там поиск использует резервный FTS5.
